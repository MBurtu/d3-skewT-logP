...
locations = {'Arlanda': {'lat':59.75, 'lon':18.0},
             'Landvetter': {'lat':57.75, 'lon':12.25},
             'Ostersund': {'lat':63.25, 'lon':14.5},
             'Gallivare': {'lat':67.25, 'lon':20.75},
             'Orsa': {'lat':61.0, 'lon':14.75},
             'Umea': {'lat':63.75, 'lon':20.25},
             'Vaxjo': {'lat':57.0, 'lon':14.75},
             'Arvidsjaur': {'lat':65.5, 'lon':19.25},
             'Visby': {'lat':57.75, 'lon':18.5},
             'Orebro': {'lat':59.25, 'lon':15.0},
             'Karlstad': {'lat':59.50, 'lon':13.25},
             'Kastrup': {'lat':55.75, 'lon':12.0},
             'Karup': {'lat':56.25, 'lon':9.0},
             'Gardemoen': {'lat':60.25, 'lon':11.0},
             'Helsinki': {'lat':60.25, 'lon':25.0},
             'Turku': {'lat':60.5, 'lon':22.25},
             'Vaasa': {'lat':63.0, 'lon':21.75},
             'Jyvaskyla': {'lat':62.25, 'lon':25.75},
             'Rovaniemi': {'lat':66.5, 'lon':25.75},
             'Joensuu': {'lat':62.75, 'lon':29.50},
             ...
             'StPetersburg': {'lat':59.75, 'lon':30.25},
